...
* `renderToReadableStream`
  * renders
    * a React tree | [Readable Web Stream](https://developer.mozilla.org/en-US/docs/Web/API/ReadableStream)
      * generate static HTML
        * if you want server-generated HTML interactive -> | client, call [`hydrateRoot`](../client/hydrateRoot)
  * ⚠️depends on⚠️
    * [Web Streams.](https://developer.mozilla.org/en-US/docs/Web/API/Streams_API)
  * ⚠️| Node.js, 
    * use BETTER [`renderToPipeableStream`](renderToPipeableStream) ⚠️
...
* `options`
  * == object /
    * contain streaming options
      ...
      * `signal`
        * OPTIONAL
        * [abort signal](https://developer.mozilla.org/en-US/docs/Web/API/AbortSignal) that lets you [abort server rendering](#aborting-server-rendering) and render the rest on the client.
