...
* limited Suspense support
  * if a component suspends -> `renderToString` IMMEDIATELY sends its fallback -- as -- HTML
* works | browser
  * ❌ALTHOUGH, [NOT recommended](#removing-rendertostring-from-the-client-code-removing-rendertostring-from-the-client-code)❌
